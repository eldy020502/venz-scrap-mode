...
class Config:
    ...
    APP_TITLE = os.environ.get("APP_TITLE", "venzapibot")
    APP_SHORT_NAME = os.environ.get("APP_SHORT_NAME", "venzapibot")
    APP_URL = os.environ.get("APP_URL", "https://telegram.dog/venzapibot")
    ...
    APP_DESCRIPTION = os.environ.get(
        "APP_DESCRIPTION",
        "created using https://telegram.dog/venzapibot"
    )
    #
    FOOTER_TEXT = os.environ.get("FTEXT", "Managed With ☕️ By @moonscrsh")
